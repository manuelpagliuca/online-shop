...
namespace Ubique.DataAccess.Migrations
{
    ...
    [Migration("20231109084831_RemoveDisplayOrderFromDb")]
    partial class RemoveDisplayOrderFromDb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ubique.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ubique.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ubique.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ubique.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Ubique.Models.OrderDetail", b =>
                {
                    b.HasOne("Ubique.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ubique.Models.Product", "Product")
                        .WithMany()
